...
export const es = {
  ...
  secondary: {
    tabs: { primary: 'Primario', selective: 'Selectivo' },
    empty: 'Aún no hay correcciones selectivas. Añade una para trabajar solo sobre una parte de la foto.',
    add: 'Añadir',
    addHint: 'Añadir una corrección selectiva',
    limit: 'Cuatro es el máximo.',
    name: 'Selectivo {index}',
    remove: 'Borrar el selectivo {index}',
    enabled: 'Activo',
    invert: 'Invertir',
    matte: 'Ver máscara',
    matteHint: 'Muestra en blanco y negro lo que la máscara está seleccionando',
    qualifier: {
      title: 'Selección por color',
      use: 'Seleccionar por color',
      pick: 'Cuentagotas',
      pickHint: 'Toca la foto para tomar el color de ahí',
      hue: 'Tono',
      saturation: 'Saturación',
    ...
    window: {
      ...
      feather: 'Difuminado',
      angle: 'Ángulo',
      hint: 'Arrastra la ventana sobre la foto para moverla o cambiarle el tamaño.',
    },
    correction: {
      title: 'Corrección',
      exposure: 'Exposición',
  ...
  history: {
    ...
    secondaryAdded: 'Selectivo {index} añadido',
    secondaryRemoved: 'Selectivo {index} borrado',
    secondary: 'Selectivo {index}',
  },
