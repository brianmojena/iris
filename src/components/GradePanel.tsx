  ...
  return (
    <aside className="panel">
          ...
          <div className="wheels">
            {WHEEL_KEYS.map((key) => (
              <ColorWheel
                ...
                balanceLabel={fill(t.grade.balance, { name: t.grade.wheels[key] })}
                masterLabel={`${t.grade.wheels[key]} · ${t.grade.master}`}
                resetLabel={fill(t.grade.resetWheel, { name: t.grade.wheels[key] })}
        ...
        <section className="group">
          <div className="group__head">
            ...
            <button
              ...
              aria-label={fill(t.grade.resetCurve, { name: t.grade.channels[channel] })}
            >
              <IconReset size={14} />
            </button>
          </div>
          ...
          <div className="segmented segmented--curve">
            {CURVE_CHANNELS.map((option) => (
              <button
                ...
                className={
                  isNeutralCurve(grade.curves[option]) ? undefined : 'segmented__marked'
                }
              >
      ...
      <div className="panel__footer">
        <button className="btn" onClick={resetGrade} disabled={isNeutralGrade(grade)}>
